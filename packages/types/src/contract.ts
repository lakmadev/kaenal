...
export const contract = c.router(
  {
    ...
    updateTemplate: {
      ...
      responses: { 200: TemplateDto, ...commonErrors },
      summary: "Edit a draft template's name + schema (optimistic; drafts only)",
    },
    versionTemplate: {
      method: "POST",
      path: "/v1/inspection-templates/:id/version",
      pathParams: z.object({ id: z.string().uuid() }),
      body: CreateTemplateBody,
      responses: { 201: TemplateDto, ...commonErrors },
      summary: "Create the next-version draft of a template (same lineage)",
    },
    publishTemplate: {
      method: "POST",
    ...
    archiveTemplate: {
      method: "POST",
      path: "/v1/inspection-templates/:id/archive",
      pathParams: z.object({ id: z.string().uuid() }),
      body: TemplateVersionBody,
      responses: { 200: TemplateDto, ...commonErrors },
      summary: "Archive a template (a superseded version drops out of the list)",
    },
    ...
    syncNcr: {
      ...
      path: "/v1/sync/ncr",
      query: SyncQuery,
      responses: { 200: NcrSyncDelta, ...commonErrors },
      summary: "Delta pull for the mobile offline mirror — NCRs changed since a cursor, plus tombstones",
    },
    syncInspections: {
      method: "GET",
      path: "/v1/sync/inspections",
      query: SyncQuery,
    ...
    listFmeas: {
      method: "GET",
      path: "/v1/fmeas",
      responses: { 200: page(FmeaDto), ...commonErrors },
      summary: "The workspace's FMEAs (fmea:view)",
    },
    createFmea: {
      method: "POST",
      path: "/v1/fmeas",
      body: CreateFmeaBody,
      responses: { 201: FmeaDto, ...commonErrors },
      summary: "Create an FMEA (fmea:manage)",
    },
    getFmea: {
      method: "GET",
      path: "/v1/fmeas/:id",
      pathParams: z.object({ id: z.string().uuid() }),
      responses: { 200: FmeaDto, ...commonErrors },
      summary: "One FMEA header (fmea:view)",
    },
    updateFmea: {
      method: "PUT",
      path: "/v1/fmeas/:id",
      ...
      body: UpdateFmeaBody,
      responses: { 200: FmeaDto, ...commonErrors },
      summary: "Edit an FMEA header (fmea:manage; optimistic)",
    },
    deleteFmea: {
      method: "POST",
      path: "/v1/fmeas/:id/delete",
      pathParams: z.object({ id: z.string().uuid() }),
      body: z.object({}),
      responses: { 200: FmeaDto, ...commonErrors },
      summary: "Delete an FMEA and its failure modes (fmea:manage)",
    },
    listFmeaItems: {
      method: "GET",
      path: "/v1/fmeas/:id/items",
      pathParams: z.object({ id: z.string().uuid() }),
      responses: { 200: page(FmeaItemDto), ...commonErrors },
      summary: "An FMEA's failure modes, scored (fmea:view)",
    },
    createFmeaItem: {
      method: "POST",
      path: "/v1/fmeas/:id/items",
      pathParams: z.object({ id: z.string().uuid() }),
      body: CreateFmeaItemBody,
      responses: { 201: FmeaItemDto, ...commonErrors },
      summary: "Add a failure mode (fmea:manage)",
    },
    updateFmeaItem: {
      method: "PUT",
      path: "/v1/fmeas/:id/items/:itemId",
      pathParams: z.object({ id: z.string().uuid(), itemId: z.string().uuid() }),
      body: UpdateFmeaItemBody,
      responses: { 200: FmeaItemDto, ...commonErrors },
      summary: "Edit a failure mode (fmea:manage; optimistic)",
    },
    deleteFmeaItem: {
      method: "POST",
      path: "/v1/fmeas/:id/items/:itemId/delete",
      pathParams: z.object({ id: z.string().uuid(), itemId: z.string().uuid() }),
      body: z.object({}),
      responses: { 200: FmeaItemDto, ...commonErrors },
