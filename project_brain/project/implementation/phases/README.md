...
- **Next free migration number: `0023`** (last shipped is `0022_supplier_portal.sql`).
...
| [P11](P11-supplier-portal.md) | Supplier Portal (external-facing) | 🟡 (security foundation ✅; writes next) | 🔴 | `supplier-portal.jsx` |
